...
cd build && rm -rf *
# Build the project
PKG_CONFIG_PATH=$build_dir/extern/libssh2/build/src cmake .. -G"$build_type" -DBUILD_CLAR=OFF -DLIBSSH2_INCLUDE_DIRS:PATH="$build_dir/extern/libssh2/include:$build_dir/extern/libssh2/build/src" -DBUILD_SHARED_LIBS=OFF
cmake --build .
ls
