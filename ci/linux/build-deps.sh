...
cd build && rm -rf *
# Build the project
PKG_CONFIG_PATH=$build_dir/extern/libssh2/build/src cmake .. -G"$build_type" -DBUILD_CLAR=OFF -DCMAKE_INCLUDE_PATH=$build_dir/extern/libssh2/include:$build_dir/extern/libssh2/build/src -DBUILD_SHARED_LIBS=ON
cmake --build .
ls
