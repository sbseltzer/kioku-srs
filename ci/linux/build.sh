...
PKG_CONFIG_PATH=$install_prefix/lib/pkgconfig:$install_prefix/lib64/pkgconfig cmake .. -G"$build_type" -DBUILD_SHARED_LIBS=$build_shared -DCMAKE_BUILD_TYPE=$build_conf
